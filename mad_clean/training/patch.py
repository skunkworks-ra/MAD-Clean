...
class PatchDictTrainer:
    ...
    def fit(
        ...
        P   = torch.from_numpy(patches_n).float().to(dev)
        N_p = P.shape[0]
        ...
        for epoch in range(self.n_epochs):
            ...
            with torch.no_grad():
                ...
                for _ in range(self.fista_iter):
                    grad = (Y @ D_fixed - P) @ D_fixed.T
                    Z_new = soft_threshold(Y - eta * grad, eta * self.lmbda)
